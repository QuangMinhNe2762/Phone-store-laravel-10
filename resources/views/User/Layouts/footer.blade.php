                ...
                <div class="row">
                    <div class="col-6">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item mb-2"><a href="{{route('home.brand.detail',$key)}}"
                    ...
                    {{-- <div class="col-6">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Chicken, meat
                                    & fish</a></li>
                            <li class="nav-item mb-2"><a href="pages/shop-grid.html" class="nav-link">Paan
                                    corner</a></li>
...
<script src="/User/custom/main.js"></script>
<!-- Theme JS -->
